...
import { GameStateModel, PlayerModel, Position } from "../utils/apiModels";
...
export class BoardStore {
  ...
  getTileOccupant = (position: Position): PlayerModel | undefined => {
    return this.getGameState().players.filter(player => Equal(player, position)).find(x => x);
  }
}